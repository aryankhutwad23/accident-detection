...
* The original package name 'com.accidentdetection.accident detection backend' is invalid and this project uses 'com.accidentdetection.accident.detection.backend' instead.
